...
== 사용자
=== 로그인
operation::oauth-controller-test/이미_존재하는_사용자[snippets="http-request,request-body,response-headers"]
...
=== 정보 가져오기
operation::user-controller-test/토큰을_바탕으로_사용자_정보_받아오기[snippets="http-request,http-response,request-headers,response-body"]
...
operation::walk-controller-test/산책_정보_등록[snippets="request-headers,request-fields,http-request,response-fields,http-response"]

=== 산책 정보 가져오기

operation::walk-controller-test/산책_정보_가져오기[snippets="request-headers,http-request,response-fields,http-response"]

=== 산책 경로 정보 리스트 가져오기

operation::walk-controller-test/날짜별_경로_및_정보_가져오기[snippets="request-headers,http-request,response-fields,http-response"]